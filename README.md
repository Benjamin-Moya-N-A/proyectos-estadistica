...
🔭 Clasificación de líneas espectrales estelares mediante ML

📁 /proyecto-espectros

Clasificación de líneas de espectros estelares en absorción o emisión. La base de datos original no traía esta clasificación etiquetada, por lo que primero se construyó el etiquetado usando los algoritmos Find Peaks y Derivate, validando que ambos detectaran correctamente los picos antes de modelar.
